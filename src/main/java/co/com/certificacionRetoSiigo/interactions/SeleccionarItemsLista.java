...
public class SeleccionarItemsLista implements Interaction {
     ...
     */
    public SeleccionarItemsLista(Target listTarget, String searchText, String tagName) {
     ...
     */
    public static SeleccionarItemsLista on(Target listTarget, String searchText, String tagName) {
        return Instrumented.instanceOf(SeleccionarItemsLista.class).withProperties(listTarget, searchText, tagName);
    }
}