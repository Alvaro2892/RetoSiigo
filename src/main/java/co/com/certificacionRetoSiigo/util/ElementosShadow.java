package co.com.certificacionRetoSiigo.util;
...
public class ElementosShadow extends By {
    ...
    private ElementosShadow(By shadowHostLocator, String... selectors) {
    ...
    public static ElementosShadow locate(By hostXPath, String... selectors) {
        return new ElementosShadow(hostXPath, selectors);
    }
